...
const Navbar: React.FC = () => {
  return (
    <div className="flex flex-col items-center py-4 flex-shrink-0 w-20 bg-orange-500 rounded-3xl place-items-center">
      <img className='flex items-center justify-center h-12 w-12 bg-cyan-50 text-cyan-700 rounded-full' src={logoImage}/>
